...
\caption{CDF of the mean video quality in the measurement runs and highest achievable mean video quality according to the optimization problem \textit{[REF to opt problem needed]. Remake figure!}}
\label{fig:opt}%
\end{figure}
